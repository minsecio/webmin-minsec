...
print ui_table_row(hlink($text{'filters_enabled'}, 'filter_enabled'), ui_yesno_radio('enabled', $filter->{'enabled'} ? 1 : 0));
print ui_table_row(hlink($text{'filters_maxretry'}, 'filter_maxretry'), ui_textbox('max_retries', $policy->{'maxretry'} // '', 15));
print ui_table_row(hlink($text{'filters_findtime'}, 'filter_findtime'), ui_textbox('find_time', $policy->{'findtime_seconds'} // '', 15));
print ui_table_row(hlink($text{'filters_bantime'}, 'filter_bantime'), ui_textbox('ban_duration', $policy->{'bantime_seconds'} // '', 15));
print ui_table_end();
...
print ui_table_row(hlink($text{'filters_test_upload'}, 'filter_test_upload'), ui_upload('upload', 60));
print ui_table_end();
